	...
	integrations: [
		starlight({
			...
			sidebar: [
				...
				{
					label: 'Guides',
					items: ['guides/weaponry_trial_1', 'guides/weaponry_trial_2', 'guides/weaponry_trial_3', 'guides/tarot_whisper_1', 'guides/tarot_whisper_2', 'guides/tarot_whisper_3', 'guides/engraving', 'guides/memory_shard_priority', 'guides/talent_priority', 'guides/shop_priority'],
				},
				{
					label: 'Characters',
